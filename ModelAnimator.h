...
public:
	...
	void PlayOnce(bool pause = false);
	void PlayOnce(UINT clipNumber, bool pause = false);
	...
	int GetCurrentClipIndex() { return m_CurrentClipIndex; }
...
private:
	...
	bool m_PlayOnce, m_PauseAfterPlay;
	const int m_IdleAnimationIndex;
};
